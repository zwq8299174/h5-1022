...
define("index",["jquery","tap","Marquee"],function(){function e(e,i){var t=i-e,n=Math.random();return e+Math.floor(n*t)}function i(){var i=$('<img src="./static/img/red-bag.png"/>'),t=$(".rain-wrap"),n=e(140,180);i.height(n),i.css({left:e(10,90)+"%",transform:"rotate("+e(-60,60)+"deg)"}),t.append(i),setTimeout(function(){i.css({"margin-top":t.outerHeight()+100+"px"})})}function t(){$(".red-bag-rain").find(".time-bar").hide(),$(".red-bag-rain").find(".bag").addClass("big")}function n(e){var i=e.accelerationIncludingGravity,n=(new Date).getTime();if(n-m>100){var a=n-m;m=n,c=i.x,l=i.y,v=i.z,Math.abs(c+l+v-f-g-h)/a*1e4>u&&(s=!0,window.clearInterval(o),t()),f=c,g=l,h=v}}var o,a=$(".mask-shadow"),r=($(".form-submit"),!1),s=!1,d={};$(".close").on("tap",function(){(0==$(this).closest(".dialog").length?$(this).closest(".already"):$(this).closest(".dialog")).hide(),a.hide()}),$(".tags").on("tap",".tag",function(){var e=$(this).data("dialog");"prize-list"==e&&$("."+e).addClass("active"),$("."+e).show(),a.show()}),$(".submit").on("tap",function(){d={name:$(".name").val(),sex:$(".sex").val(),mobile:$(".mobile").val(),code:$(".code").val(),region:{province:$(".province").val(),city:$(".city").val()}},console.log(d)}),$(".bottom-bar").liMarquee({scrollamount:150}),$(".prize-list ul").liMarquee({direction:"up",scrollamount:80}),$(".join").on("tap",function(){if(a.show(),r)$(".already").show();else{var e=$(".red-bag-rain");e.show(),o=window.setInterval(i,300),window.DeviceMotionEvent&&window.addEventListener("devicemotion",n,!1),setTimeout(function(){e.find(".time-bar").addClass("end")}),setTimeout(function(){window.clearInterval(o),window.removeEventListener("devicemotion",n,!1)},1e4),setTimeout(function(){s||t()},11e3),r=!0}}),$(".red-bag-rain").find(".bag").on("tap",function(){$(".prize").show(),$(this).closest(".red-bag-rain").hide()}),$(".income").on("tap",function(){$(".prize-list").removeClass("active").show(),$(this).closest(".prize").hide()}),window.DeviceMotionEvent&&window.addEventListener("devicemotion",n,!1);var c,l,v,u=4e3,m=0,f=0,g=0,h=0});