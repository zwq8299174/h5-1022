...
(function(){define("ajax",["jquery","jquery"],function(e){return{extend:function(e,n){for(var t in n)e[t]=n[t];return e},ajaxPost:function(n){var t=n.success;delete n.success;var a={url:"",type:"POST",data:{},dataType:"json",contentType:"application/json",success:function(e){"200"==e.code?t(e.data):alert(e.msg)},complete:function(e){},error:function(e){alert("服务器错误")},beforeSend:function(e){}};(a=this.extend(a,n)).data=JSON.stringify(a.data),console.log(a),e.ajax(a)},ajaxGet:function(n){var t=n.success;delete n.success;var a={url:"",type:"GET",contentType:"application/json",success:function(e){"200"==e.code?t(e.data):alert(e.msg)},complete:function(e){},error:function(e){alert("服务器错误")},beforeSend:function(e){}};a=this.extend(a,n),e.ajax(a)}}})}).call(this);
define("baseSet",function(){return{postServer:"http://dev.saojie.me/ylxb/",pageHost:"./../"}});
(function(){define("api",["ajax","baseSet","jquery","ajax"],function(n,t){return{getProvince:function(e){n.ajaxPost({url:t.postServer+"getProvinceList",success:function(n){e(n)}})},getCity:function(e,s){n.ajaxPost({url:t.postServer+"getCityList",data:{provinceId:e},success:function(n){s(n)}})},binding:function(e,s){n.ajaxPost({url:t.postServer+"binding",data:e,success:function(n){s(n)}})},draw:function(e){n.ajaxPost({url:t.postServer+"draw",success:function(n){e(n)}})},getWinnerList:function(e){n.ajaxPost({url:t.postServer+"getWinnerList",success:function(n){e(n)}})},sendCode:function(e){n.ajaxPost({url:t.postServer+"sendCode",success:function(n){e(n)}})}}})}).call(this);
...
"use strict";define(["api","jquery","tap","Marquee"],function(e){$(function(){function t(){var e=!1,t=0;for(var n in v)""==v[n]?($("."+n).addClass("error"),t+=1):"mobile"!=n||v[n].match(/^1[3|4|5|7|8][0-9]{9}$/)||($("."+n).addClass("error"),t+=1);return t>0?$(".error-msg").addClass("show"):(e=!0,$(".error-msg").removeClass("show")),e}function n(e,t){var n=t-e,a=Math.random();return e+Math.floor(a*n)}function a(){var e=$('<img src="./static/img/red-bag.png"/>'),t=$(".rain-wrap"),a=n(140,180);e.height(a),e.css({left:n(10,90)+"%",transform:"rotate("+n(-60,60)+"deg)"}),t.append(e),setTimeout(function(){e.css({"margin-top":t.outerHeight()+100+"px"})})}function i(){$(".red-bag-rain").find(".time-bar").hide(),$(".red-bag-rain").find(".bag").addClass("big")}function o(e){$(".awards-name").text(e.price),$(".awards-cost").text(e.value),$(".awards-code").text(e.coupon),d.show();var t=$(".red-bag-rain");t.find(".time-bar").removeClass("end"),t.show(),s=window.setInterval(a,300),window.DeviceMotionEvent&&window.addEventListener("devicemotion",r,!1),setTimeout(function(){t.find(".time-bar").addClass("end")},100),setTimeout(function(){window.clearInterval(s),window.removeEventListener("devicemotion",r,!1)},1e4),setTimeout(function(){c||i()},11e3)}function r(e){var t=e.accelerationIncludingGravity,n=(new Date).getTime();if(n-b>100){var a=n-b;b=n,f=t.x,h=t.y,g=t.z,Math.abs(f+h+g-y-C-I)/a*1e4>w&&(p.play(),c=!0,window.clearInterval(s),i()),y=f,C=h,I=g}}var s,d=$(".mask-shadow"),l=($(".form-submit"),"1"==localStorage.getItem("once")),c=!1,u=60,v={name:"",gender:"",mobile:"",code:"",provinceId:"",cityId:"",couponId:""},m={},p=document.getElementById("mp3");e.getProvince(function(e){var t="",n=!0,a=!1,i=void 0;try{for(var o,r=e[Symbol.iterator]();!(n=(o=r.next()).done);n=!0){var s=o.value;t+='<option value="'+s.id+'">'+s.name+"</option>"}}catch(e){a=!0,i=e}finally{try{!n&&r.return&&r.return()}finally{if(a)throw i}}$(".provinceId").append(t)}),e.getWinnerList(function(e){var t="",n="",a=!0,i=!1,o=void 0;try{for(var r,s=e[Symbol.iterator]();!(a=(r=s.next()).done);a=!0){var d=r.value;t+="<li><span>"+d.name+"</span><span>"+d.price+"</span></li>",n+="<span>"+d.date+"，"+d.name+"，获得价值"+d.value+"元"+d.price+"。</span>"}}catch(e){i=!0,o=e}finally{try{!a&&s.return&&s.return()}finally{if(i)throw o}}$(".prize-list ul").append(t).liMarquee({direction:"up",scrollamount:80}),$(".bottom-bar").append(n).liMarquee({scrollamount:150})}),$(".close").on("tap",function(){var e=0==$(this).closest(".dialog").length?$(this).closest(".already"):$(this).closest(".dialog");e.hasClass("form-submit")&&(u=60,c=!1,$(".red-bag-rain").find(".time-bar").show(),$(".red-bag-rain").find(".bag").removeClass("big")),e.hide(),d.hide()}),$(".tags").on("tap",".tag",function(){var e=$(this).data("dialog"),t=$("."+e).outerHeight();"prize-list"==e&&$("."+e).addClass("active"),$("."+e).css({"margin-top":"-"+t/2+"px"}).show(),d.show()}),$(".form-submit").find("input").on("input",function(e){$(this).hasClass("mobile")?new RegExp(/^1[3|4|5|7|8][0-9]{9}$/).test($(this).val())&&$(this).removeClass("error"):""!=$(this).val()&&$(this).removeClass("error")}),$("select").on("focus",function(){$(this).addClass("open")}),$("select").on("blur",function(){$(this).removeClass("open")}),$(".provinceId").on("change",function(){v.provinceId=$(this).val(),""!=$(this).val()&&$(this).removeClass("error"),e.getCity($(this).val(),function(e){console.log(e);var t="",n=!0,a=!1,i=void 0;try{for(var o,r=e[Symbol.iterator]();!(n=(o=r.next()).done);n=!0){var s=o.value;t+='<option value="'+s.id+'">'+s.name+"</option>"}}catch(e){a=!0,i=e}finally{try{!n&&r.return&&r.return()}finally{if(a)throw i}}$(".cityId").append(t)})}),$(".cityId").on("change",function(){v.cityId=$(this).val(),""!=$(this).val()&&$(this).removeClass("error")}),$(".gender").on("change",function(){""!=$(this).val()&&$(this).removeClass("error"),v.gender=$(this).val()}),$(".submit").on("tap",function(){v.name=$(".name").val(),v.mobile=$(".mobile").val(),v.code=$(".code").val(),t()&&e.binding(v,function(e){l=!0,localStorage.setItem("once","1"),$(".form-submit").hide();var t=$(".prize-list"),n=t.outerHeight();t.removeClass("active"),t.css("margin-top","-"+n/2+"px").show()})}),$(".join").on("tap",function(){if(p.play(),p.pause(),l){d.show();var t=$(".prize").outerHeight();$(".already").css("margin-top","-"+t/2+"px").show()}else""==v.couponId?e.draw(function(e){v.couponId=e.id,m=e,o(e)}):o(m)}),$(".send-code").on("tap",function(){var t=$(this);if(!t.hasClass("can"))return!1;e.sendCode(function(e){t.text(u+"s").removeClass("can"),u--;var n=setInterval(function(){u>0?(t.text(u+"s").removeClass("can"),u--):(t.text("发送验证码").addClass("can"),clearInterval(n))},1e3)})}),$(".red-bag-rain").find(".bag").on("tap",function(){var e=$(".prize").outerHeight();$(".prize").css("margin-top","-"+e/2+"px").show(),$(this).closest(".red-bag-rain").hide()}),$(".income").on("tap",function(){$(this).closest(".prize").hide(),setTimeout(function(){$(".form-submit").show()},300)}),window.DeviceMotionEvent&&window.addEventListener("devicemotion",r,!1);var f,h,g,w=4e3,b=0,y=0,C=0,I=0})});