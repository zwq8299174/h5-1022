...
(function(){define("ajax",["jquery","jquery"],function(e){return{extend:function(e,n){for(var t in n)e[t]=n[t];return e},ajaxPost:function(n){var t=n.success;delete n.success;var c={url:"",type:"POST",data:{},dataType:"json",contentType:"application/x-www-form-urlencoded;charset=UTF-8",success:function(e){t(e)},complete:function(e){},error:function(e){alert("服务器错误")},beforeSend:function(e){}};c=this.extend(c,n),e.ajax(c)},ajaxGet:function(n){var t=n.success;delete n.success;var c={url:"",type:"GET",contentType:"x-www-form-urlencoded",success:function(e){"200"==e.code?t(e.data):alert(e.msg)},complete:function(e){},error:function(e){alert("服务器错误")},beforeSend:function(e){}};c=this.extend(c,n),e.ajax(c)}}})}).call(this);
...
"use strict";define(["api","jquery","tap","Marquee"],function(e){$(function(){function a(){e.getWinnerList(function(e){var a="",t="",o=!0,i=!1,n=void 0;try{for(var r,s=e.data[Symbol.iterator]();!(o=(r=s.next()).done);o=!0){var d=r.value;a+="<li><span>"+d.name.slice(0,1)+"**</span><span>"+d.price+"</span></li>",t+="<span>"+d.date+"，"+d.name.slice(0,1)+"**，获得价值"+d.value+"元"+d.price+"。</span>"}}catch(e){i=!0,n=e}finally{try{!o&&s.return&&s.return()}finally{if(i)throw n}}$(".prize-list ul").empty().append(a).liMarquee({direction:"up",scrollamount:80}),$(".bottom-bar").empty().append(t).liMarquee({scrollamount:150})})}function t(){var e=!1,a=0;for(var t in f)""==f[t]?($("."+t).addClass("error"),a+=1):"mobile"!=t||f[t].match(/^1[3|4|5|7|8][0-9]{9}$/)||($("."+t).addClass("error"),a+=1);return a>0?$(".error-msg").addClass("show"):(e=!0,$(".error-msg").removeClass("show")),e}function o(e,a){var t=a-e,o=Math.random();return e+Math.floor(o*t)}function i(){var e=$('<img src="./static/img/red-bag.png"/>'),a=$(".rain-wrap"),t=o(140,180);e.height(t),e.css({left:o(10,90)+"%",transform:"rotate("+o(-60,60)+"deg)"}),a.append(e),setTimeout(function(){e.css({"margin-top":a.outerHeight()+100+"px"})})}function n(){$(".red-bag-rain").find(".time-bar").hide(),$(".red-bag-rain").find(".bag").addClass("big")}function r(e){201==e.code&&(a(),c=201,$(".awards-name").text(e.data.price),$(".awards-cost").text(e.data.value),$(".awards-code").text(e.data.code)),v.show();var t=$(".red-bag-rain");t.find(".time-bar").removeClass("end"),t.show(),h=!0,l=window.setInterval(i,300),window.DeviceMotionEvent&&window.addEventListener("devicemotion",d,!1),setTimeout(function(){t.find(".time-bar").addClass("end")},100),setTimeout(function(){window.clearInterval(l),window.removeEventListener("devicemotion",d,!1),h=!1},1e4),setTimeout(function(){u||n()},11e3)}function s(){e.draw(function(e){if(g=e,409==e.code){v.show();a=$(".already").outerHeight();$(".already").css("margin-top","-"+a/2+"px").show()}else if(410==e.code){$(".awards-name").text(e.data.price),$(".awards-cost").text(e.data.value),$(".awards-code").text(e.data.code),v.show();var a=$(".prize-list").outerHeight();$(".prize-list").removeClass("active").css("margin-top","-"+a/2+"px").show()}else 406==e.code?alert("验证码错误"):r(e)})}function d(e){e.stopPropagation(),e.preventDefault();var a=e.accelerationIncludingGravity,t=(new Date).getTime();if(t-I>100){var o=t-I;I=t,b=a.x,y=a.y,C=a.z,Math.abs(b+y+C-z-H-E)/o*1e4>x&&h&&(w.play(),u=!0,window.clearInterval(l),n()),z=b,H=y,E=C}}$("body").height($(window).height());var l,c,p,v=$(".mask-shadow"),h=($(".form-submit"),!1),u=!1,m=60,f={name:"",gender:"",mobile:"",code:"",provinceId:"",cityId:"666"},g={},w=document.getElementById("mp3");e.login(function(e){console.log(e),p=e.data,g=e,c=e.code}),e.getProvince(function(e){var a="",t=!0,o=!1,i=void 0;try{for(var n,r=e.data[Symbol.iterator]();!(t=(n=r.next()).done);t=!0){var s=n.value;a+='<option value="'+s.id+'">'+s.name+"</option>"}}catch(e){o=!0,i=e}finally{try{!t&&r.return&&r.return()}finally{if(o)throw i}}$(".provinceId").append(a)}),a(),$(".close").on("tap",function(){var e=0==$(this).closest(".dialog").length?$(this).closest(".already"):$(this).closest(".dialog");e.hasClass("form-submit")&&(m=60,u=!1,$(".red-bag-rain").find(".time-bar").show(),$(".red-bag-rain").find(".bag").removeClass("big")),e.hide(),v.hide()}),$(".tags").on("tap",".tag",function(){var e=$(this).data("dialog"),a=$("."+e).outerHeight();"prize-list"==e&&$("."+e).addClass("active"),$("."+e).css({"margin-top":"-"+a/2+"px"}).show(),v.show()}),$(".form-submit").find("input").on("input",function(e){$(this).hasClass("mobile")?new RegExp(/^1[3|4|5|7|8][0-9]{9}$/).test($(this).val())&&$(this).removeClass("error"):""!=$(this).val()&&$(this).removeClass("error")}),$("select").on("focus",function(){$(this).addClass("open")}),$("select").on("blur",function(){$(this).removeClass("open")}),$(".provinceId").on("change",function(){f.provinceId=$(this).val(),""!=$(this).val()&&$(this).removeClass("error"),e.getCity($(this).val(),function(e){console.log(e);var a="",t=!0,o=!1,i=void 0;try{for(var n,r=e.data[Symbol.iterator]();!(t=(n=r.next()).done);t=!0){var s=n.value;a+='<option value="'+s.id+'">'+s.name+"</option>"}}catch(e){o=!0,i=e}finally{try{!t&&r.return&&r.return()}finally{if(o)throw i}}$(".cityId").append(a)})}),$(".cityId").on("change",function(){f.cityId=$(this).val(),""!=$(this).val()&&$(this).removeClass("error")}),$(".gender").on("change",function(){""!=$(this).val()&&$(this).removeClass("error"),f.gender=$(this).val()}),$(".submit").on("tap",function(){f.name=$(".name").val(),f.mobile=$(".mobile").val(),f.code=$(".code").val(),t()&&e.binding(f,function(e){console.log(e),c=e.code,406==e.code?alert("验证码错误"):($(".form-submit").remove(),s())})}),$(".again").on("tap",function(){$(".no-prize").hide(),$(".bag").removeClass("big"),$(".time-bar").show().removeClass("end"),s()}),$(".join").on("tap",function(){if(w.play(),w.pause(),console.log(c),408==c)v.show(),$(".form-submit").show();else if(409==c){v.show();e=$(".already").outerHeight();$(".already").css("margin-top","-"+e/2+"px").show()}else if(410==c){console.log(g),$(".awards-name").text(g.data.price),$(".awards-cost").text(g.data.value),$(".awards-code").text(g.data.code),v.show();e=$(".prize-list").outerHeight();$(".prize-list").removeClass("active").css("margin-top","-"+e/2+"px").show()}else if(201==c){v.show();var e=$(".prize-list").outerHeight();$(".prize-list").removeClass("active").css("margin-top","-"+e/2+"px").show()}else s()}),$(".send-code").on("tap",function(){var a=$(this);if(!a.hasClass("can")||!$(".mobile").val().match(/^1[3|4|5|7|8][0-9]{9}$/))return!1;e.sendCode($(".mobile").val(),function(e){a.text(m+"s").removeClass("can"),m--;var t=setInterval(function(){m>0?(a.text(m+"s").removeClass("can"),m--):(a.text("发送验证码").addClass("can"),clearInterval(t))},1e3)})}),$(".red-bag-rain").find(".bag").on("tap",function(){if(201==g.code){e=$(".prize").outerHeight();$(".prize").css("margin-top","-"+e/2+"px").show(),$(this).closest(".red-bag-rain").hide()}else{var e=$(".no-prize").outerHeight();$(".no-prize").css("margin-top","-"+e/2+"px").show(),$(this).closest(".red-bag-rain").hide()}}),$(".share").on("tap",function(){$(".share-wrapper").show()}),$(".share-wrapper").on("tap",".close",function(e){e.stopPropagation(),e.preventDefault(),$(".share-wrapper").hide()}),window.DeviceMotionEvent&&window.addEventListener("devicemotion",d,!1);var b,y,C,x=4e3,I=0,z=0,H=0,E=0})});