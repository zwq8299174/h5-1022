...
"use strict";define(["api","jquery","tap","Marquee"],function(e){$(function(){function a(){e.getWinnerList(function(e){var a="",t="",i=!0,o=!1,n=void 0;try{for(var r,s=e.data[Symbol.iterator]();!(i=(r=s.next()).done);i=!0){var d=r.value;a+="<li><span>"+d.name.slice(0,1)+"**</span><span>"+d.price+"</span></li>",t+="<span>"+d.date+"，"+d.name.slice(0,1)+"**，获得价值"+d.value+"元"+d.price+"。</span>"}}catch(e){o=!0,n=e}finally{try{!i&&s.return&&s.return()}finally{if(o)throw n}}p.find("ul").empty().append(a).liMarquee({direction:"up",scrollamount:80}),$(".bottom-bar").empty().append(t).liMarquee({scrollamount:150})})}function t(e,a){var t=a-e,i=Math.random();return e+Math.floor(i*t)}function i(){var e=$('<img src="./static/img/red-bag.png"/>'),a=$(".rain-wrap"),i=t(140,180);e.height(i),e.css({left:t(10,90)+"%",transform:"rotate("+t(-60,60)+"deg)"}),a.append(e),setTimeout(function(){e.css({"margin-top":a.outerHeight()+100+"px"})})}function o(){$(".red-bag-rain").find(".time-bar").hide(),$(".red-bag-rain").find(".bag").addClass("big")}function n(e){201==e.code&&(c=201,$(".awards-name").text(e.data.price),$(".awards-cost").text(e.data.value),$(".awards-code").text(e.data.code)),l.show();var t=$(".red-bag-rain");t.find(".time-bar").removeClass("end"),t.show(),g=!0,d=window.setInterval(i,300),window.DeviceMotionEvent&&window.addEventListener("devicemotion",s,!1),setTimeout(function(){t.find(".time-bar").addClass("end")},100),m||(setTimeout(function(){window.clearInterval(d),window.removeEventListener("devicemotion",s,!1),g=!1,a()},1e4),setTimeout(function(){o()},11e3))}function r(){e.draw(function(e){if(v=e,c=e.code,409==e.code){l.show();a=u.outerHeight();u.css("margin-top","-"+a/2+"px").show()}else if(410==e.code){$(".awards-name").text(e.data.price),$(".awards-cost").text(e.data.value),$(".awards-code").text(e.data.code),l.show();var a=p.outerHeight();p.removeClass("active").css("margin-top","-"+a/2+"px").show()}else 406==e.code?alert("验证码错误"):408==e.code?window.location.href="index.html":n(e)})}function s(e){e.stopPropagation(),e.preventDefault();var a=e.accelerationIncludingGravity,t=(new Date).getTime();if(t-M>100){var i=t-M;M=t,x=a.x,y=a.y,C=a.z,Math.abs(x+y+C-E-I-z)/i*1e4>H&&g&&(window.clearInterval(d),window.removeEventListener("devicemotion",s,!1),m=!0,window.clearInterval(d),o()),E=x,I=y,z=C}}$("body").height($(window).height());var d,c,l=$(".mask-shadow"),p=$(".prize-list"),h=$(".prize"),w=$(".no-prize"),u=$(".already"),g=!1,m=!1,f=60,v={},b=document.getElementById("mp3");r(),a(),$(".close").on("tap",function(){var e=0==$(this).closest(".dialog").length?$(this).closest(".already"):$(this).closest(".dialog");e.hasClass("form-submit")&&(f=60,m=!1,$(".red-bag-rain").find(".time-bar").show(),$(".red-bag-rain").find(".bag").removeClass("big")),e.hide(),l.hide()}),$(".tags").on("tap",".tag",function(){var e=$(this).data("dialog"),a=$("."+e).outerHeight();"prize-list"==e&&$("."+e).addClass("active"),$("."+e).css({"margin-top":"-"+a/2+"px"}).show(),l.show()}),$(".again").on("tap",function(){w.hide(),$(".bag").removeClass("big"),$(".time-bar").show().removeClass("end"),r()}),$(".red-bag-rain").find(".bag").on("tap",function(){if(b.play(),201==v.code){e=h.outerHeight();h.css("margin-top","-"+e/2+"px").show(),$(this).closest(".red-bag-rain").hide()}else{var e=w.outerHeight();w.css("margin-top","-"+e/2+"px").show(),$(this).closest(".red-bag-rain").hide()}}),$(".share").on("tap",function(){$(".share-wrapper").show()}),$(".share-wrapper").on("tap",".close",function(e){e.stopPropagation(),e.preventDefault(),$(".share-wrapper").hide()});var x,y,C,H=4e3,M=0,E=0,I=0,z=0;$(".join").on("tap",function(){if(c)if(408==c)l.show(),$form.show();else if(409==c){l.show();e=u.outerHeight();u.css("margin-top","-"+e/2+"px").show()}else if(410==c){console.log(v),$(".awards-name").text(v.data.price),$(".awards-cost").text(v.data.value),$(".awards-code").text(v.data.code),l.show();e=p.outerHeight();p.removeClass("active").css("margin-top","-"+e/2+"px").show()}else if(201==c){l.show();var e=p.outerHeight();p.removeClass("active").css("margin-top","-"+e/2+"px").show()}else window.location.href="rain.html"})})});